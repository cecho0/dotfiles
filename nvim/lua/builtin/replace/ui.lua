...
local function create_win()
  ...
  local search_resize_grp = api.nvim_create_augroup("SearchResizeGrp", { clear = true })
  ...
  local search_del_grp = api.nvim_create_augroup("SearchDelGrp", { clear = true })
  api.nvim_create_autocmd("BufWinLeave", {
    group = search_del_grp,
    callback = function(opts)
      api.nvim_del_augroup_by_id(search_del_grp)
